...
namespace FASTECH
{
	public partial class EziMOTIONPlusRLib
	{
		...
		public static int FAS_MoveSingleAxisIncPosEx(byte nPortNo, byte iSlaveNo, int lIncPos, uint lVelocity, MOTION_OPTION_EX ExOption)
		{
			int nRtn = FMM_OK;
			byte[] buff = new byte[MOTION_OPTION_EX.BUFF_SIZE];
			...
			nRtn = FAS_MoveSingleAxisIncPosEx(nPortNo, iSlaveNo, lIncPos, lVelocity, buff);
		...
		//EZI_PLUSR_API int WINAPI	FAS_GetLatchCountAll(BYTE nPortNo, BYTE iSlaveNo, unsigned long* puAllCount);
		[DllImport("EziMOTIONPlusR.dll")]
		public static extern int FAS_GetLatchCountAll(byte nPortNo, byte iSlaveNo, uint[] puAllCount);

		//EZI_PLUSR_API int WINAPI	FAS_GetLatchCountAll32(BYTE nPortNo, BYTE iSlaveNo, unsigned long* puAllCount);
		[DllImport("EziMOTIONPlusR.dll")]
		public static extern int FAS_GetLatchCountAll32(byte nPortNo, byte iSlaveNo, uint[] puAllCount);
		...
		////					Ez-IO AD Functions
		////------------------------------------------------------------------
		//EZI_PLUSR_API int WINAPI	FAS_SetADConfig(BYTE nPortNo, BYTE iSlaveNo, BYTE channel, enum AD_DATA_TYPE type, long value, long* recv);
		[DllImport("EziMOTIONPlusR.dll")]
		public static extern int FAS_SetADConfig(byte nPortNo, byte iSlaveNo, byte channel, int type, int value, ref int recv);

		//EZI_PLUSR_API int WINAPI	FAS_GetADConfig(BYTE nPortNo, BYTE iSlaveNo, BYTE channel, enum AD_DATA_TYPE type, long* value);
		[DllImport("EziMOTIONPlusR.dll")]
		public static extern int FAS_GetADConfig(byte nPortNo, byte iSlaveNo, byte channel, int type, ref int value);

		//EZI_PLUSR_API int WINAPI	FAS_LoadADConfig(BYTE nPortNo, BYTE iSlaveNo);
		[DllImport("EziMOTIONPlusR.dll")]
		public static extern int FAS_LoadADConfig(byte nPortNo, byte iSlaveNo);

		//EZI_PLUSR_API int WINAPI	FAS_SaveADConfig(BYTE nPortNo, BYTE iSlaveNo);
		[DllImport("EziMOTIONPlusR.dll")]
		public static extern int FAS_SaveADConfig(byte nPortNo, byte iSlaveNo);

		//EZI_PLUSR_API int WINAPI	FAS_ReadADValue(BYTE nPortNo, BYTE iSlaveNo, BYTE channel, short* advalue);
		[DllImport("EziMOTIONPlusR.dll")]
		public static extern int FAS_ReadADValue(byte nPortNo, byte iSlaveNo, byte channel, ref short advalue);

		//EZI_PLUSR_API int WINAPI	FAS_ReadADAllValue(BYTE nPortNo, BYTE iSlaveNo, BYTE offset, AD_BUFFER* adbuffer);
		[DllImport("EziMOTIONPlusR.dll")]
		protected static extern int FAS_ReadADAllValue(byte nPortNo, byte iSlaveNo, byte offset, byte[] adbuffer);
		public static int FAS_ReadADAllValue(byte nPortNo, byte iSlaveNo, byte offset, out AD_BUFFER adbuffer)
		{
			byte[] buffer = new byte[16];
			int nRtn = FMM_OK;

			nRtn = FAS_ReadADAllValue(nPortNo, iSlaveNo, offset, buffer);
		...
		[DllImport("EziMOTIONPlusR.dll")]
		protected static extern int FAS_GetAllADResult(byte nPortNo, byte iSlaveNo, byte[] result);
		public static int FAS_GetAllADResult(byte nPortNo, byte iSlaveNo, out AD_RESULT result)
		{
			byte[] buffer = new byte[112];
			int nRtn = FMM_OK;

			nRtn = FAS_GetAllADResult(nPortNo, iSlaveNo, buffer);
		...
		[DllImport("EziMOTIONPlusR.dll")]
		public static extern int FAS_GetADResult(byte nPortNo, byte iSlaveNo, byte channel, ref float adresult);

		//EZI_PLUSR_API int WINAPI	FAS_SetADRange(BYTE nPortNo, BYTE iSlaveNo, BYTE channel, enum AD_RANGE range);
		[DllImport("EziMOTIONPlusR.dll")]
		protected static extern int FAS_SetADRange(byte nPortNo, byte iSlaveNo, byte channel, int range);
		public static int FAS_SetADRange(byte nPortNo, byte iSlaveNo, byte channel, AD_RANGE range)
		{
			return FAS_SetADRange(nPortNo, iSlaveNo, channel, (int)range);
		}
	}
}
