...
namespace FrontCameraAssembleEquipment.MVVM.ViewModels
{
    public class TrayCamLoaderManualViewModel : AppManualViewModel
    {
        ...
        public TrayCamLoaderManualViewModel(NavigationStore navigationStore, MachineStatus machineStatus, Processes processes, PositionList positionList , Devices devices, ProcessConfig processConfig, VaccumList vaccumList , RecipeList recipeList) 
