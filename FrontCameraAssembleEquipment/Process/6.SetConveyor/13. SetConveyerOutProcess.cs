...
namespace FrontCameraAssembleEquipment.Process
{
    public class SetConveyerOutProcess : ProcessBase<ESequence>
    {
        ...
        public override bool PreProcess()
        {
            ...
            if (ProcessMode == EProcessMode.Run && (Sequence == ESequence.AutoRun || Sequence == ESequence.CVOut_Load || Sequence == ESequence.CVOut_Unload))
            {
                if (IsOneConveyorFrontLine)
                {
                ...
                if (IsOneConveyorFrontLine && (Sequence == ESequence.CVOut_Unload || Sequence == ESequence.CVOut_Load))
                {
